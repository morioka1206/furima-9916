...
ActiveRecord::Schema.define(version: 2021_03_05_125236) do
  ...
  create_table "customer_infomations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_record_id"], name: "index_customer_infomations_on_purchase_record_id"
  end
  ...
  add_foreign_key "customer_infomations", "purchase_records"
